...
class ImageProcessorApp:
    ...
    def enable_buttons(self):
        # Enable all buttons across different functional groups
        buttons = [
            # Basic Operations
            ...
            self.simple_halftone_button,
            self.advanced_halftone_button,

            # Histogram Operations
            self.display_histogram_button,
            self.histogram_equalization_button,
            ...
            # Advanced Edge Detection
            self.homogeneity_button,
            self.difference_button,
            self.dog_button,
            self.contrast_button,
            self.variance_button,
            self.range_button,
